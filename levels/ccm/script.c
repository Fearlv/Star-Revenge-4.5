...
LOAD_MODEL_FROM_GEO(14, metalsign),
LOAD_MODEL_FROM_GEO(15, starhole),
...
OBJECT_WITH_ACTS(12,9328,-1246,6662,0,0,0,0x3000000, bhvHiddenRedCoinStar,8),
...
OBJECT_WITH_ACTS(15,2145,-524,12353,0,43,0,0x450000, bhvWarp,56),
OBJECT_WITH_ACTS(13,2661,-524,12290,0,180,0,0x940000, bhvBobombBuddy,7),
OBJECT_WITH_ACTS(14,17280,-1574,809,0,0,0,0x950000, bhvMessagePanel,8),
...
OBJECT_WITH_ACTS(0,8,4,525,9,0,0,13, editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,2,5,480,9,0,0,14, editor_Scroll_Texture,31),
RETURN()
};
