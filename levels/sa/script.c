...
OBJECT_WITH_ACTS(0,8640,8448,8704,0,0,0,0xb58a0000,editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,8512,8320,12288,0,0,0,0xad680000,editor_Scroll_Texture,31),
RETURN()
};
