...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 293, 1604, -10),
	TRAJECTORY_POS(1, /*pos*/ -961, 1658, 206),
	TRAJECTORY_POS(2, /*pos*/ -4957, 2554, 3543),
	TRAJECTORY_POS(3, /*pos*/ -5998, 2654, 5895),
	TRAJECTORY_POS(4, /*pos*/ -6678, 2654, 6230),
	TRAJECTORY_END(),
};
const Trajectory KoopaTHI_path[] = {
	TRAJECTORY_POS(0, /*pos*/ -10397, -3149, -13163),
	TRAJECTORY_POS(1, /*pos*/ -10380, -3150, -13170),
	TRAJECTORY_POS(2, /*pos*/ 3271, -3149, -13651),
	TRAJECTORY_POS(3, /*pos*/ 2824, -1349, -130),
	TRAJECTORY_POS(4, /*pos*/ -10988, -449, -88),
	TRAJECTORY_POS(5, /*pos*/ -11467, -449, 953),
	TRAJECTORY_POS(6, /*pos*/ -11738, -449, 11620),
	TRAJECTORY_POS(7, /*pos*/ -2526, -1949, 13287),
	TRAJECTORY_POS(8, /*pos*/ 10116, -1949, 13287),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702EC3C_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 589, 1931, 3259),
	TRAJECTORY_POS(1, /*pos*/ -348, 1931, 3259),
	TRAJECTORY_POS(2, /*pos*/ -1972, 2621, 3259),
	TRAJECTORY_POS(3, /*pos*/ -5257, 2621, 3259),
	TRAJECTORY_POS(4, /*pos*/ -5257, 2621, -4839),
	TRAJECTORY_POS(5, /*pos*/ -5257, 3820, -4839),
	TRAJECTORY_POS(6, /*pos*/ 4944, 3820, -4839),
	TRAJECTORY_POS(7, /*pos*/ 4944, 3820, 2048),
	TRAJECTORY_END(),
};
const Trajectory rr_seg7_trajectory_0702ECC0_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ 7220, 2162, -5899),
	TRAJECTORY_POS(1, /*pos*/ 6197, 2231, -5200),
	TRAJECTORY_POS(2, /*pos*/ 6193, 2412, -3450),
	TRAJECTORY_POS(3, /*pos*/ 4948, 2491, -2711),
	TRAJECTORY_POS(4, /*pos*/ 5477, 2680, -905),
	TRAJECTORY_POS(5, /*pos*/ 4007, 2687, -46),
	TRAJECTORY_END(),
};
const Trajectory ccm_seg7_trajectory_0701669C_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ -11019, -2153, 497),
	TRAJECTORY_POS(1, /*pos*/ -11019, 2723, 497),
	TRAJECTORY_POS(2, /*pos*/ -11045, 2723, -755),
	TRAJECTORY_END(),
};
const Trajectory bitfs_seg7_trajectory_070159AC_RM2C_path[] = {
	TRAJECTORY_POS(0, /*pos*/ -7554, 1844, 8309),
	TRAJECTORY_POS(1, /*pos*/ -8104, 1844, 7600),
	TRAJECTORY_POS(2, /*pos*/ -7039, 1844, 6773),
	TRAJECTORY_POS(3, /*pos*/ -9792, 1844, 3211),
	TRAJECTORY_POS(4, /*pos*/ -8715, 1844, 2375),
	TRAJECTORY_END(),
};

//hmc_seg7_trajectory_0702B86C_RM2C Has a level embedded value, Default fallback used.
...
//lll_seg7_trajectory_0702856C_RM2C Has a level embedded value, Default fallback used.
...
//lll_seg7_trajectory_07028660_RM2C Has a level embedded value, Default fallback used.
...
//rr_seg7_trajectory_0702ED9C_RM2C Has a level embedded value, Default fallback used.
...
//rr_seg7_trajectory_0702EEE0_RM2C Has a level embedded value, Default fallback used.
...
//ccm_seg7_trajectory_penguin_race_RM2C Has a level embedded value, Default fallback used.
...
//ccm_seg7_trajectory_snowman_RM2C Has a level embedded value, Default fallback used.
const Trajectory ccm_seg7_trajectory_snowman_RM2C_path[] = {
...
//bob_seg7_metal_ball_path0_RM2C Has a level embedded value, Default fallback used.
const Trajectory bob_seg7_metal_ball_path0_RM2C_path[] = {
...
//bob_seg7_metal_ball_path1_RM2C Has a level embedded value, Default fallback used.
const Trajectory bob_seg7_metal_ball_path1_RM2C_path[] = {
...
//ttm_seg7_trajectory_RM2C Has a level embedded value, Default fallback used.
const Trajectory ttm_seg7_trajectory_RM2C_path[] = {
...
const Trajectory sThiHugeMetalBallTraj_RM2C_path[] = {
...
const Trajectory sThiTinyMetalBallTraj_RM2C_path[] = {
