...
Light_t Light_koopa_flag_geo_0x6000850 = {
	{ 223, 159, 31}, 0, { 223, 159, 31}, 0, { 40, 40, 40}, 0
};

Light_t Light_koopa_flag_geo_0x6000868 = {
	{ 80, 40, 0}, 0, { 80, 40, 0}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_koopa_flag_geo_0x6000848 = {
	{55, 39, 7}, 0, {55, 39, 7}, 0
};

Ambient_t Light_koopa_flag_geo_0x6000860 = {
	{20, 10, 0}, 0, {20, 10, 0}, 0
};

Gfx DL_koopa_flag_geo_0x6000a08[] = {
	gsDPPipeSync(),
...
Gfx DL_koopa_flag_geo_0x6000968[] = {
...
Gfx DL_koopa_flag_geo_0x6000b08[] = {
	gsDPPipeSync(),
...
Gfx DL_koopa_flag_geo_0x6000ab8[] = {
...
Gfx DL_koopa_flag_geo_0x6000ae8[] = {
	gsSPVertex(VB_koopa_flag_geo_0x6000a68, 5, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 4, 2, 0),
	gsSPEndDisplayList(),
};

Gfx DL_koopa_flag_geo_0x6000bf8[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, SHADE, 0, 0, 0, TEXEL0, 0, 0, 0, SHADE),
	gsSPGeometryMode(G_CULL_BACK|G_LIGHTING, 0),
	gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
Gfx DL_koopa_flag_geo_0x6000bc0[] = {
	gsDPSetTextureImage(0, 2, 1, koopa_flag_geo__texture_06000048),
	gsDPLoadSync(),
	gsDPLoadBlock(7, 0, 0, 1023, 256),
...
Gfx DL_koopa_flag_geo_0x6000ce0[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, SHADE, 0, 0, 0, TEXEL0, 0, 0, 0, SHADE),
	gsSPGeometryMode(G_CULL_BACK|G_LIGHTING, 0),
	gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
Gfx DL_koopa_flag_geo_0x6000ca8[] = {
	gsDPSetTextureImage(0, 2, 1, koopa_flag_geo__texture_06000048),
	gsDPLoadSync(),
	gsDPLoadBlock(7, 0, 0, 1023, 256),
...
Gfx DL_koopa_flag_geo_0x6000db0[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
	gsSPGeometryMode(G_CULL_BACK|G_LIGHTING, 0),
	gsDPPipeSync(),
...
Gfx DL_koopa_flag_geo_0x6000d90[] = {
	gsSPVertex(VB_koopa_flag_geo_0x6000d50, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Gfx DL_koopa_flag_geo_0x6000e38[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
	gsSPGeometryMode(G_CULL_BACK|G_LIGHTING, 0),
	gsDPPipeSync(),
...
Gfx DL_koopa_flag_geo_0x6000e20[] = {
