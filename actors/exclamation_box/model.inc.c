...
Vtx VB_exclamation_box_geo_0x80190a0[] = {
	{{{ -25, 1, 26 }, 0, { 992, 992 }, { 129, 0, 0, 255}}},
	{{{ -25, 52, 26 }, 0, { 992, 0 }, { 129, 0, 0, 255}}},
	{{{ -25, 52, -25 }, 0, { 0, 0 }, { 129, 0, 0, 255}}},
	{{{ 26, 1, 26 }, 0, { 992, 992 }, { 0, 0, 127, 255}}},
...
Vtx VB_exclamation_box_geo_0x80191a0[] = {
...
Gfx DL_exclamation_box_geo_0x8019318[] = {
	...
	gsSPBranchList(DL_exclamation_box_geo_0x8019008),
};
...
Gfx DL_exclamation_box_geo_0x8019378[] = {
	gsSPDisplayList(DL_exclamation_box_geo_0x80192d0),
	gsDPSetTextureImage(0, 2, 1, exclamation_box_geo__texture_08014628),
	gsDPLoadSync(),
	gsDPLoadBlock(7, 0, 0, 1023, 256),
	gsSPDisplayList(DL_exclamation_box_geo_0x8019220),
	gsDPTileSync(),
	...
	gsSPBranchList(DL_exclamation_box_geo_0x8019280),
};

Gfx DL_exclamation_box_geo_0x80192d0[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
	gsSPGeometryMode(G_SHADING_SMOOTH, 0),
	gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
Gfx DL_exclamation_box_geo_0x8019220[] = {
	gsSPLight(&Light_exclamation_box_geo_0x8012e18.col, 1),
	gsSPLight(&Light_exclamation_box_geo_0x8012e10.col, 2),
	gsSPVertex(VB_exclamation_box_geo_0x80190a0, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
	gsSP2Triangles(3, 5, 6, 0, 7, 8, 9, 0),
...
Gfx DL_exclamation_box_geo_0x8019280[] = {
	gsSPVertex(VB_exclamation_box_geo_0x80191a0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSPTexture(65535, 65535, 0, 0, 0),
	gsDPPipeSync(),
...
Gfx DL_exclamation_box_geo_0x80193d8[] = {
	gsSPDisplayList(DL_exclamation_box_geo_0x8019058),
...
Gfx DL_exclamation_box_geo_0x8019438[] = {
	gsSPDisplayList(DL_exclamation_box_geo_0x80192d0),
