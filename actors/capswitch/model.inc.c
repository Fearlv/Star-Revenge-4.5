...
// 0x05002CC8 -- changing this you can remove the exclamation somehow
...
// 0x05002E60 -- don't change this, nothing will happen anyway
...
// 0x05002F60 -- don't change this, nothing will happen anyway
...
//0x05003180 -- if you change this somehow make the switch head transparent
...
// 0x05003350 - 0x05003370 -- tf is this
Lights1 capswitch_seg5_dl_05003350_f3dlite_material_002_lights = gdSPDefLights1(
	0x77, 0x51, 0x7F,
	0xFF, 0x0, 0x0, 0x49, 0x49, 0x49);

// 0x05003370 - 0x05003350 -- assigns the light (color) to the switch (RED SWITCH)
const Gfx capswitch_seg5_dl_05003350[] = {
    gsSPLight(&capswitch_seg5_lights_05001BE8.l, 1),
    gsSPLight(&capswitch_seg5_lights_DIFFUSEFAV.a, 2),
    gsSPDisplayList(capswitch_seg5_dl_05003280),
    gsSPEndDisplayList(),
};

// 0x05003370 - 0x05003390 -- assigns the light (color) to the switch (GREEN SWITCH)
...
// 0x05003390 - 0x050033B0 -- assigns the light (color) to the switch (BLUE SWITCH)
...
// 0x050033B0 - 0x050033D0 -- assigns the light (color) to the switch (YELLOW SWITCH)
