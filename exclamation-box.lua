...
local sExclamationBoxContents = {
    { 0, 0, 0, E_MODEL_NONE,  id_bhvWarp },
    { 1, 0, 0, E_MODEL_KOOPA_SHELL,  id_bhvKoopaShell },
    { 2, 0, 0, E_MODEL_BOBOMB_BUDDY,  id_bhvBobombBuddyOpensCannon },
    { 3, 0, 0, E_MODEL_KOOPA_SHELL,  id_bhvKoopaShell },
    { 4, 0, 0, E_MODEL_YELLOW_COIN,  id_bhvSingleCoinGetsSpawned },
    { 5, 0, 0, E_MODEL_YELLOW_COIN,  id_bhvThreeCoinsSpawn },
    { 6, 0, 0, E_MODEL_YELLOW_COIN,  id_bhvTenCoinsSpawn },
    ...
    { 15, 0, 0, E_MODEL_ENEMY_LAKITU,  id_bhvEnemyLakitu },
    { 16, 0, 0, E_MODEL_FLYGUY, id_bhvFlyGuy },
    { 17, 0, 0, E_MODEL_AMP,  id_bhvCirclingAmp },
    { 18, 0, 0, E_MODEL_CHUCKYA,  id_bhvChuckya },
    { 19, 0, 0, E_MODEL_BLACK_BOBOMB,  id_bhvBobomb },
    { 20, 0, 0, E_MODEL_RED_COIN,  id_bhvRedCoin },
    { 21, 0, 0, E_MODEL_BLUE_COIN,  id_bhvMovingBlueCoin },
    { 22, 0, 0, E_MODEL_PIRANHA_PLANT,  id_bhvPiranhaPlant },
    { 23, 0, 0, E_MODEL_KOOPA_WITHOUT_SHELL,  id_bhvKoopa },
    { 24, 0, 0, E_MODEL_WHOMP,  id_bhvWhompKingBoss },
    { 25, 0, 0, E_MODEL_KING_BOBOMB,  id_bhvKingBobomb },
    { 26, 0, 0, E_MODEL_BOWLING_BALL,  id_bhvFireSpitter },
    { 27, 0, 0, E_MODEL_BOO,  id_bhvGhostHuntBoo },
    { 28, 0, 0, E_MODEL_MAD_PIANO,  id_bhvMadPiano },
    { 29, 0, 0, E_MODEL_NONE,  id_bhvCoinFormation },
    { 30, 0, 0, E_MODEL_BULLY,  id_bhvSmallBully },
    { 31, 0, 0, E_MODEL_SNUFIT, id_bhvSnufit },
    { 32, 0, 0, E_MODEL_SCUTTLEBUG,  id_bhvScuttlebug },
    { 33, 0, 0, E_MODEL_SPINDRIFT,  id_bhvSpindrift },
    ...
    { 39, 0, 0, 240, bhv_custom_0x130050d0 },
    { 40, 0, 0, E_MODEL_TREASURE_CHEST_LID,  id_bhvBetaChestBottom },
    { 41, 0, 0, E_MODEL_WOODEN_SIGNPOST,  id_bhvMessagePanel },
    { 42, 0, 0, E_MODEL_BOWLING_BALL,  id_bhvPitBowlingBall },
    { 43, 0, 0, E_MODEL_KLEPTO,  id_bhvKlepto },
    { 44, 0, 0, E_MODEL_SKEETER,  id_bhvSkeeter },
    { 45, 0, 0, E_MODEL_NONE,  id_bhvBbhTumblingBridge }, --20 Coins
